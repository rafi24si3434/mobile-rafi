...
import com.example.unluckyyyapps.databinding.ItemNewsBinding
...
class NewsAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.tvNewsDescription.text = news.description ?: "Baca selengkapnya..."
        holder.binding.tvNewsSourceDate.text = "${news.sourceName} • ${formatDate(news.publishedAt)}"
